...
export const complianceTemplates: ComplianceTemplate[] = [
  {
    ...
    format: "docx",
    status: "available",
    filePath: "/templates/ropa-gdpr.docx",
    regulations: ["gdpr"],
    appFrameworks: ["gdpr"],
  },
  {
    ...
    format: "docx",
    status: "available",
    filePath: "/templates/pristupova-politika-nzkb.docx",
    regulations: ["nis2"],
    appFrameworks: ["nis2"],
  },
  {
    ...
    format: "docx",
    status: "available",
    filePath: "/templates/politika-rizeni-rizik.docx",
  ...
  },
  {
    ...
    format: "docx",
    status: "available",
    filePath: "/templates/incident-response-plan.docx",
  ...
  },
  {
    ...
    format: "docx",
    status: "available",
    filePath: "/templates/politika-dodavatelu.docx",
    regulations: ["nis2", "iso-27001"],
    appFrameworks: ["nis2", "iso27001"],
  },
  {
    ...
    format: "docx",
    status: "available",
    filePath: "/templates/vendor-assessment-dotaznik.docx",
    regulations: ["nis2"],
    appFrameworks: ["nis2"],
  },
  {
    ...
    format: "docx",
    status: "available",
    filePath: "/templates/bcp-plan-kontinuity.docx",
    regulations: ["nis2", "iso-27001"],
    appFrameworks: ["nis2", "iso27001"],
  },
  {
    ...
    format: "docx",
    status: "available",
    filePath: "/templates/dpia-sablona.docx",
    regulations: ["gdpr"],
    appFrameworks: ["gdpr"],
  },
  {
    ...
    format: "xlsx",
    status: "available",
    filePath: "/templates/soa-iso27001.xlsx",
  ...
  },
  {
    ...
    format: "xlsx",
    status: "available",
    filePath: "/templates/gap-analyza-nizsi-rezim.xlsx",
    regulations: ["nis2"],
    appFrameworks: ["nis2"],
  },
  {
    ...
    format: "xlsx",
    status: "available",
    filePath: "/templates/gap-analyza-vyssi-rezim.xlsx",
    regulations: ["nis2"],
    appFrameworks: ["nis2"],
  },
];
