...
### Stack
- Language and version: TypeScript 5, React 19.2.4
- Framework(s): Next.js 15.5.15 App Router, Tailwind CSS 4, Clerk, Drizzle ORM, Neon serverless Postgres, next-intl, Inngest
- Package manager: npm (`package-lock.json` is present)
- Runtime / deployment target: Next.js app; Vercel-oriented services are configured in code/env examples
...
- Database migration apply: `npm run db:migrate`
