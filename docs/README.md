...
- `weekly-reviews/` - weekly operating reviews and template.

## Archive Policy

`archive/` keeps historical plans, outreach worksheets, and premature playbooks so they are not mistaken for current priorities.

Archived material is read-only context unless `../PROJECT_PLAN.md` explicitly revives it.
