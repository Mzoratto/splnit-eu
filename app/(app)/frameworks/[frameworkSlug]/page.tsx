...
export default async function FrameworkDetailPage({
  ...
  return (
    <section className="space-y-8">
      <PageHeader
        breadcrumb="Dashboard / Předpisy"
        eyebrow={seedFramework.regulator}
        title={seedFramework.nameCs}
        subtitle={seedFramework.descriptionCs}
        actions={
          <Link
      ...
      <div className="grid gap-4 lg:grid-cols-[auto_1fr_1fr]">
        ...
        <article className="card">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium">Stav frameworku</h2>
          </div>
        ...
        <section className="grid gap-4 lg:grid-cols-[1fr_1fr]">
          ...
          <article className="card">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-medium">Certifikační odkazy</h2>
            </div>
      ...
      <section className="overflow-hidden rounded-lg border border-border bg-surface">
        <div className="flex items-center gap-2 border-b border-border p-5">
          ...
          <h2 className="text-lg font-medium">Kontroly a povinnosti</h2>
        </div>
