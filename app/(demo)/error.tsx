  ...
  return (
    <main className="min-h-[60vh] bg-surface px-6 py-16 text-foreground">
      <div className="mx-auto max-w-2xl rounded-lg border border-border bg-[var(--surface-raised)] p-8 shadow-sm">
        <p className="text-sm font-semibold uppercase tracking-wide text-foreground/60">Demo není dostupné</p>
        <h1 className="mt-3 text-2xl font-semibold tracking-tight">Ukázku se nepodařilo načíst.</h1>
        <p className="mt-3 text-sm leading-6 text-foreground/70">
          Zkuste demo obnovit. Interní detaily chyby nezobrazujeme veřejně.
        </p>
        <button
          type="button"
          onClick={reset}
